...
| name | description |
| --- | --- |
| static [AddFacilityExceptionHandler](FacilityAspNetCoreExtensions/AddFacilityExceptionHandler.md)(…) | Adds a Facility exception handler to the service collection. (2 methods) |
